        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DigestArticleCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "IT, AI, гаджеты", "Технологии", "tech" },
                    { 2, "Научные открытия", "Наука", "science" },
                    { 3, "Экономика и финансы", "Бизнес", "business" },
                    { 4, "Спортивные новости", "Спорт", "sport" },
                    { 5, "Мировые новости", "Мир", "world" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_UserId_TopicId",
                table: "Subscriptions",
